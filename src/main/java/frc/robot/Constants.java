...
public final class Constants {
  ...
  public static final class ModuleConstants {
    ...
    public static final int kDrivingMotorPinionTeeth = 12; // 12T pinion gear for low gear ratio
    ...
    public static final double kDrivingMotorReduction = (45.0 * 22) / (kDrivingMotorPinionTeeth * 15); //only touch this if changing the 22t spur for extra high ratios
